// axios.get("https://api.themoviedb.org/3/movie/top_rated?api_key=1413f426e96bd33478cc6d119de2ee0f&language&language=en-US&page=1").then(res => {
//     console.log(res);
// })
...
axios.get("https://api.themoviedb.org/3/movie/top_rated?api_key=1413f426e96bd33478cc6d119de2ee0f&language=en-US&page=1").then(res => {
    ...
    wrap.innerHTML = res.data.results.map(val => {
        return `<div class="singleMovie">
                <a href="/firstmovieapi/singleMovie.html?id=${val.id}">
